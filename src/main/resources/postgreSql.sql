...
-- Users
INSERT INTO public.users(id, role_id, user_status_id, "email", "name", "password", "phone_number", "usercode")
...
INSERT INTO public.project_status(id, "name")
VALUES (2, 'Enviado');
ALTER SEQUENCE public.project_status_id_seq RESTART 3;

-- Academic Periods
INSERT INTO public.academic_periods(id, year, "period")
VALUES (1, 2025, 'I');
INSERT INTO public.academic_periods(id, year, "period")
VALUES (2, 2025, 'II');
INSERT INTO public.academic_periods(id, year, "period")
...
INSERT INTO public.academic_periods(id, year, "period")
VALUES (10, 2029, 'II');
ALTER SEQUENCE public.academic_periods_id_seq RESTART 11;
